    ...
    return (
        <section className={className}>
            <header>
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-zinc-500 font-bold uppercase tracking-widest leading-relaxed">
            ...
            <form onSubmit={updatePassword} className="mt-8 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    <PrimaryButton disabled={processing} className="px-8 py-3 shadow-lg shadow-red-500/20">Simpan Kata Sandi</PrimaryButton>
