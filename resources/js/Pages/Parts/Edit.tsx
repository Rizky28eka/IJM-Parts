...
export default function Edit({ part, categories, brands }: Props) {
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-bold leading-tight text-gray-900 dark:text-white tracking-tight">
                    Edit <span className="text-red-500 underline decoration-red-500/30 underline-offset-8">Konfigurasi Part</span>
                </h2>
            }
        >
            <Head title="Edit Suku Cadang" />
            ...
            <div className="py-12 px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl">
                    <div className="bg-white dark:bg-zinc-900 p-8 shadow-2xl sm:rounded-[2.5rem] border border-gray-200 dark:border-zinc-800 transition-colors">
                        <div className="mb-10">
                            <h3 className="text-lg font-black text-gray-900 dark:text-white tracking-tight uppercase">Detail Suku Cadang</h3>
                            <p className="text-xs text-gray-500 dark:text-zinc-500 font-bold uppercase tracking-widest mt-1">Perbarui informasi katalog inventory</p>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="mt-1 block w-full border-gray-300 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-300 focus:border-red-500 focus:ring-red-500/20 rounded-xl shadow-sm text-sm transition-colors"
                                            value={data.brand_id}
                                            onChange={(e) => setData('brand_id', parseInt(e.target.value))}
                                            required
                                        >
                                ...
                                <div className="space-y-6">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <InputLabel htmlFor="stock" value="Stok Sekarang" className="text-[10px] font-black uppercase tracking-widest mb-1 text-gray-500" />
                                            <TextInput
                                                id="stock"
                                                type="number"
                                                className="mt-1 block w-full"
