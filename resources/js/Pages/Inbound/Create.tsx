...
export default function Create({ parts, suppliers }: Props) {
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-bold leading-tight text-gray-900 dark:text-white tracking-tight">
                    Catat <span className="text-red-500 underline decoration-red-500/30 underline-offset-8">Barang Masuk</span>
                </h2>
            }
        >
                    ...
                    <form onSubmit={submit} className="space-y-8">
                        ...
                        <div className="overflow-hidden bg-white dark:bg-zinc-900 shadow-2xl sm:rounded-[2.5rem] border border-gray-200 dark:border-zinc-800 transition-colors">
                            <div className="px-8 py-6 border-b border-gray-100 dark:border-zinc-800 bg-gray-50/50 dark:bg-zinc-900/50">
                                <h3 className="text-sm font-black uppercase tracking-[0.2em] text-gray-900 dark:text-white">Informasi Penerimaan</h3>
                                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">Detail dokumen dan pengirim</p>
                            </div>
                            <div className="p-8 grid grid-cols-1 sm:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    <InputLabel htmlFor="supplier_id" value="Supplier / Pengirim *" className="text-[10px] font-black uppercase tracking-widest text-gray-500" />
                                    <select
                                        id="supplier_id"
                                ...
                                <div className="space-y-2">
                                    <InputLabel htmlFor="date" value="Tanggal Penerimaan *" className="text-[10px] font-black uppercase tracking-widest text-gray-500" />
                                    <TextInput
                                        id="date"
                                        type="date"
                                ...
                                <div className="space-y-2">
                                    <InputLabel htmlFor="invoice_number" value="No. Faktur / Surat Jalan" className="text-[10px] font-black uppercase tracking-widest text-gray-500" />
                                    <TextInput
                                        id="invoice_number"
                                        type="text"
                                        className="mt-1 block w-full"
                                ...
                                <div className="space-y-2">
                                    <InputLabel htmlFor="notes" value="Keterangan / Catatan" className="text-[10px] font-black uppercase tracking-widest text-gray-500" />
                                    <textarea
                                        id="notes"
                        ...
                        <div className="overflow-hidden bg-white dark:bg-zinc-900 shadow-2xl sm:rounded-[2.5rem] border border-gray-200 dark:border-zinc-800 transition-colors">
                            <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 dark:border-zinc-800 bg-gray-50/50 dark:bg-zinc-900/50">
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mt-1">Item yang akan ditambahkan ke stok</p>
                                </div>
                                <button
                                    type="button"
                                    onClick={addItem}
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        {selectedPart && (
                                                            <p className="px-1 text-[9px] font-bold text-gray-400 dark:text-zinc-600 uppercase tracking-widest">
                                                                Stok Sistem: <span className="text-gray-700 dark:text-zinc-400">{selectedPart.stock} {selectedPart.unit}</span>
                                                            </p>
                                                        )}
                                                    </div>
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="relative">
                                                            <input
                                                                type="number"
                                                                min="1"
                                                                className="block w-full border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 text-gray-900 dark:text-zinc-100 rounded-xl shadow-sm focus:border-red-500 focus:ring-red-500/20 text-xs transition-colors pr-12"
                                                                value={item.quantity}
