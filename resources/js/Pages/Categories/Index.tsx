            ...
            header={
                <div className="flex items-center justify-between">
                    <h2 className="text-xl font-bold leading-tight text-gray-900 dark:text-white tracking-tight">
                        Inventory <span className="text-red-500 underline decoration-red-500/30 underline-offset-8">Kategori</span>
                    </h2>
                    <Link
                            ...
                            <table className="min-w-full divide-y divide-gray-100 dark:divide-zinc-800">
                                <thead className="bg-gray-50 dark:bg-[#0c0c0e]">
                                    <tr className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 dark:text-zinc-500">
                                        <th className="px-6 py-5 text-left">NAMA KATEGORI</th>
                                        <th className="px-6 py-5 text-left">SLUG SISTEM</th>
                                    ...
                                    {categories.length === 0 ? (
                                        <tr>
                                            <td colSpan={3} className="px-6 py-20 text-center">
                                                <div className="text-gray-400 dark:text-zinc-600 text-xs font-black uppercase tracking-[0.2em]">Belum Ada Kategori Terdaftar</div>
                                            </td>
                                        </tr>
                                    ) : (
                                        categories.map((category) => (
                                            <tr key={category.id} className="hover:bg-gray-50 dark:hover:bg-zinc-800/30 transition-colors group">
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="text-xs font-mono text-gray-400 dark:text-zinc-600 uppercase tracking-tighter">
                                                        {category.slug}
                                                    </div>
                                                </td>
